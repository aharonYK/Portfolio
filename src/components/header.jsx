...
<Link to="/projects" > <button className="buttonH" id="pro"><img src={glob} alt="" className="img1" />Projects</button></Link>
   <Link to="/resume"> <button className="buttonH" id="res"><img src={doc} alt="" className="img1" />Resume</button></Link>
</div>
</div>
     );
}
